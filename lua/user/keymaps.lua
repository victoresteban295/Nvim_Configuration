...
keymap("n", "<leader>e", ":Lex 30<cr>", opts) -- Space + e to open a file explore to the left 
...
-- Telescope Plugin --
keymap("n", "<leader>f", "<cmd>Telescope find_files<cr>", opts) -- Space + f to find find files in current working directory
keymap("n", "<c-t>", "<cmd>Telescope live_grep<cr>", opts) -- Ctrl + t to find specfic text in files in current working directory

-- Nvimtree
keymap("n", "<leader>e", ":NvimTreeToggle<cr>", opts)

-- Null-ls (Formats Files)
